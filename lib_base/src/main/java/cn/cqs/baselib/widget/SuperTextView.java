...
import cn.cqs.baselib.widget.alpha.IAlphaViewHelper;
import cn.cqs.baselib.widget.alpha.XUIAlphaViewHelper;
...
public class SuperTextView extends AppCompatTextView {
     ...
     * @return 对象
     */
    public SuperTextView setShapeType(int type) {
        this.shapeType = type;
        return this;
    }
     ...
     * @return 对象
     */
    public SuperTextView setTextGravity(int gravity) {
     ...
     * @return 对象
     */
    public SuperTextView setShapeSelectorDisableColor(int color) {
     ...
     * @return 对象
     */
    public SuperTextView setShapeStrokeDashWidth(float strokeDashWidth) {
     ...
     * @return 对象
     */
    public SuperTextView setShapeSizeWidth(int sizeWidth) {
     ...
     * @return 对象
     */
    public SuperTextView setShapeSizeHeight(int sizeHeight) {
     ...
     * @return 对象
     */
    public SuperTextView setShapeGradientOrientation(int gradientOrientation) {
     ...
     * @return 对象
     */
    public SuperTextView setShapeGradientCenterX(int gradientCenterX) {
     ...
     * @return 对象
     */
    public SuperTextView setShapeGradientCenterY(int gradientCenterY) {
     ...
     * @return 对象
     */
    public SuperTextView setShapeGradientGradientRadius(int gradientGradientRadius) {
     ...
     * @return 对象
     */
    public SuperTextView setShapeGradientStartColor(int gradientStartColor) {
     ...
     * @return 对象
     */
    public SuperTextView setShapeGradientCenterColor(int gradientCenterColor) {
     ...
     * @return 对象
     */
    public SuperTextView setShapeGradientEndColor(int gradientEndColor) {
     ...
     * @return 对象
     */
    public SuperTextView setShapeGradientType(int gradientType) {
     ...
     * @return 对象
     */
    public SuperTextView setShapeGradientUseLevel(boolean gradientUseLevel) {
     ...
     * @return 对象
     */
    public SuperTextView setShapeUseSelector(boolean useSelector) {
