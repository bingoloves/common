...
//        }
    ...
    //设置默认露出的高度，参数单位px
    public DragLayout2 setDefaultHeight(float defaultHeight) {
        this.defaultHeight = defaultHeight;
        return this;
    }

    //设置预计露出的高度，参数单位px
    public DragLayout2 setRealHeight(float realHeight) {
...
//                }
    ...
    public DragLayout2 addTouchView(View touchView) {
        this.touchView = touchView;
        return this;
    }

    public DragLayout2 setOnScrollStateListener(OnScrollStateListener onScrollStateListener) {
