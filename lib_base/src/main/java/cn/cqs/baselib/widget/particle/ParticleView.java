package cn.cqs.baselib.widget.particle;
...
public class ParticleView extends View {
    ...
    private OnParticleAnimListener mParticleAnimListener;
    ...
    public void setOnParticleAnimListener(OnParticleAnimListener particleAnimListener) {
        mParticleAnimListener = particleAnimListener;
    }

    public interface OnParticleAnimListener {
        void onAnimationEnd();
    }
