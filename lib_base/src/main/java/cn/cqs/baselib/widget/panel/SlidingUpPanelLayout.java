package cn.cqs.baselib.widget.panel;
...
public class SlidingUpPanelLayout extends ViewGroup {
    ...
    public SlidingUpPanelLayout(Context context, AttributeSet attrs, int defStyle) {
        ...
        if (mShadowHeight > 0) {
            if (mIsSlidingUp) {
                mShadowDrawable = getResources().getDrawable(R.drawable.shadow_above);
            } else {
                mShadowDrawable = getResources().getDrawable(R.drawable.shadow_below);
            }
        } else {
            mShadowDrawable = null;
        }
