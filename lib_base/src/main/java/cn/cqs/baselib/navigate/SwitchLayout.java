package cn.cqs.baselib.navigate;
...
public abstract class SwitchLayout {
	...
	public static void getSlideFromBottom(Activity context, boolean isCloseActivity, Interpolator interpolator) {
		activity = context;
	...
	public static void getSlideFromRight(Activity context, boolean isCloseActivity, Interpolator interpolator) {
		activity = context;
	...
	public static void getSlideToRight(Activity context, boolean isCloseActivity, Interpolator interpolator) {
		activity = context;
